    ...
    >
      <div className="mx-auto max-w-[1400px] px-6 md:px-16 lg:px-24">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          >
            Dernières{' '}
            <span style={{ color: 'var(--mauve)' }}>actualités.</span>
          </h2>
        </div>
          ...
          {MOCK_NEWS.map((article, i) => (
            <a
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 16px 48px rgba(70,29,76,0.1)';
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden">
                <img 
                  ...
                  alt={article.title}
                  className="w-full h-full object-cover transform group-hover:scale-[1.05] transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]"
                  style={{ filter: 'saturate(0.9) contrast(1.02)' }}
                />
                {/* Purple gradient overlay on image */}
                <div className="absolute inset-0 bg-gradient-to-t from-[rgba(70,29,76,0.15)] to-transparent opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
