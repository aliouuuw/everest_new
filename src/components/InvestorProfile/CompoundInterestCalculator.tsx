        ...
        {results && (
          <div className="pt-6 border-t border-[var(--mauve-10)] mt-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div>
                <span className="outils-invest-label text-[var(--night-60)] block mb-1" style={{ fontFamily: 'var(--font-primary)' }}>Investissement initial</span>
              ...
              <div>
                <span className="outils-invest-label text-[var(--night-60)] block mb-1" style={{ fontFamily: 'var(--font-primary)' }}>Total des versements</span>
              ...
              <div>
                <span className="outils-invest-label text-[var(--night-60)] block mb-1" style={{ fontFamily: 'var(--font-primary)' }}>Intérêts gagnés</span>
                <span className="font-bold text-lg text-[#16a34a]" style={{ fontFamily: 'var(--font-primary)' }}>{formatCurrency(results.totalInterest)}</span>
              </div>
              <div>
                <span className="outils-invest-label text-[var(--night-60)] block mb-1" style={{ fontFamily: 'var(--font-primary)' }}>Valeur future</span>
