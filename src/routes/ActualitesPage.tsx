    ...
    <div ref={pageRef}>
              ...
              <button
                ...
                className={`px-4 py-2 text-[11px] tracking-[0.1em] uppercase transition-all duration-300 border font-primary ${
                  i === 0 
                    ...
                    : 'font-light text-[rgba(10,10,10,0.6)] bg-transparent border-black/10 hover:border-black/30'
                }`}
              >
                {cat}
              </button>
      ...
      <section className="bg-[var(--pure-white)] py-24 md:py-40 border-b border-black/10">
        <div className="mx-auto max-w-[1600px] px-6 md:px-12">
          <a href={FEATURED.href} className="actu-reveal group grid grid-cols-1 lg:grid-cols-12 gap-0 border border-black/10 hover:border-[var(--jaune-or)]/50 transition-all duration-500">
            <div className="lg:col-span-7 relative overflow-hidden">
              ...
              <div className="absolute top-6 left-6 z-10">
                <span className="inline-block bg-[var(--jaune-or)] px-4 py-1.5 text-[10px] tracking-[0.15em] uppercase font-bold text-[var(--night)]">
                  À la une
                </span>
              </div>
            </div>
            <div className="lg:col-span-5 p-8 lg:p-12 flex flex-col justify-center bg-[var(--white-smoke)]/30">
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="w-1 h-1 bg-[rgba(10,10,10,0.3)]" />
              ...
              <h2 className="mb-6 group-hover:text-[var(--jaune-or)] transition-colors duration-300 font-display-aptos text-3xl md:text-4xl leading-[1.2] text-[var(--night)]">
                {FEATURED.title}
              </h2>
              <p className="mb-8 font-light text-base leading-[1.7] text-[rgba(10,10,10,0.7)]">
                {FEATURED.excerpt}
              </p>
              <span className="inline-flex items-center gap-3 text-[11px] tracking-[0.15em] uppercase group-hover:gap-4 transition-all duration-300 font-bold text-[var(--night)]">
                Lire le communiqué
        ...
        <div className="mx-auto max-w-[1600px] px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="lg:col-span-8">
              <div className="actu-reveal flex items-center justify-between mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-display-aptos text-2xl text-[var(--night)]">
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="text-[10px] tracking-[0.12em] uppercase font-bold text-[var(--jaune-or)]">
                          {article.category}
                        </span>
                      ...
                      <h4 className="mb-3 group-hover:text-[var(--jaune-or)] transition-colors duration-300 font-display-aptos text-xl leading-[1.35] text-[var(--night)]">
                        {article.title}
                      </h4>
                      <p className="mb-4 line-clamp-2 font-light text-sm leading-[1.65] text-[rgba(10,10,10,0.7)]">
                        {article.excerpt}
                      </p>
                      <span className="inline-flex items-center gap-2 text-[10px] tracking-[0.12em] uppercase text-[var(--jaune-or)] group-hover:gap-3 transition-all duration-300 font-bold">
                        Lire <FiArrowRight />
                      </span>
                    </div>
                  </a>
              ...
              <div className="actu-reveal flex justify-center mt-12">
                <button className="group px-8 py-4 border border-black/10 text-[11px] tracking-[0.15em] uppercase hover:border-[var(--jaune-or)] hover:text-[var(--jaune-or)] transition-all duration-300 font-bold text-[var(--night)]">
            ...
            <aside className="lg:col-span-4 flex flex-col gap-10">
              ...
              <div className="actu-reveal relative overflow-hidden min-h-[400px] flex flex-col justify-end p-8 bg-[var(--night)]">
                <div className="absolute inset-0">
                  <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=800&q=80" alt="" className="w-full h-full object-cover opacity-40" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[var(--night)] via-[var(--night)]/85 to-[var(--night)]/40" />
                </div>
                <div className="relative z-10">
                  <span className="inline-block border border-[var(--jaune-or)]/40 px-3 py-1 mb-5 text-[9px] tracking-[0.2em] uppercase font-bold text-[var(--jaune-or)]">
                    Publicité
                  </span>
                  <h4 className="text-xl mb-3 font-display-aptos leading-[1.25] text-[var(--pure-white)]">
                    Ouvrez votre compte-titres 100% en ligne
                  </h4>
                  <p className="text-sm mb-6 font-light leading-[1.6] text-white/55">
              ...
              {/* Categories */}
              <div className="actu-reveal border border-black/10 p-8">
                <div className="w-8 h-px bg-[var(--jaune-or)] mb-6" />
                <h3 className="font-display-aptos text-lg mb-6 text-[var(--night)]">
                  Rubriques
                </h3>
                <ul className="flex flex-col">
                  {['Communiqués de presse', 'Mentions médias', 'Mises à jour', 'Événements'].map((cat, i) => (
                    <li key={i}>
                      <a
                        href="#"
                        className="flex justify-between items-center py-3 text-sm hover:text-[var(--jaune-or)] transition-colors duration-200 border-b border-black/5 last:border-0 font-normal text-[var(--night)]"
                      >
                        <span>{cat}</span>
              ...
              <div className="actu-reveal border border-black/10 p-8">
                <div className="w-8 h-px bg-[var(--jaune-or)] mb-6" />
                <h3 className="font-display-aptos text-lg mb-2 text-[var(--night)]">
                  Newsletter
                </h3>
                ...
                <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
                  <input
                    ...
                    className="bg-white border border-black/10 px-4 py-3 text-sm focus:outline-none focus:border-[var(--jaune-or)] transition-colors"
                  />
                  <button
                    type="submit"
                    className="bg-[var(--night)] text-white px-4 py-3 text-[11px] tracking-[0.12em] uppercase hover:bg-[var(--jaune-or)] hover:text-[var(--night)] transition-colors duration-300 font-bold"
                  >
                    S'abonner
                  </button>
                </form>
