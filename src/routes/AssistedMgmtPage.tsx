...
export const AssistedMgmtPage = () => {
  ...
  return (
    <div className="bg-[var(--pure-white)] text-[var(--night)] font-primary">
          ...
          <div className="relative z-10 w-full page-container">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 items-end">
              ...
              <div className="md:col-span-4 pb-4">
                ...
                <a href="#marche" className="btn-primary-dark group inline-flex items-center justify-center gap-4 px-8 py-4 text-xs font-bold tracking-[0.2em] uppercase transition-all mt-4 w-fit">
        ...
        <section ref={toolsSectionRef} className="reveal py-24 md:py-40 section-bg-light">
          <div className="page-container relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
              <div className="lg:col-span-4">
                <div className="sticky top-32">
                  <span className="px-4 py-1.5 rounded-full bg-[var(--jaune-or)]/15 text-[10px] font-bold tracking-[0.3em] text-[var(--jaune-or)] uppercase inline-block mb-8">Valeur ajoutée</span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 text-xs">
                          ...
                          <span className="border border-black/20 rounded-full px-3 py-1">Retraite</span>
                        </div>
                      </div>
                    </div>
                  </li>
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 text-xs">
                          ...
                          <span className="border border-black/20 rounded-full px-3 py-1">Diversification</span>
                        </div>
                      </div>
                    </div>
                  </li>
