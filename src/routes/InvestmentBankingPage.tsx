          ...
          <div className="relative mx-auto max-w-6xl px-6 py-20 sm:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="luxury-subheading mt-5 pt-8">Nous concevons des solutions de financement sur mesure et les exécutons avec la plus haute rigueur. De l'idée à la réalisation, votre succès est notre priorité.</p>

                {/* Key Differentiators */}
                <div className="mt-8 grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-3">
                    <FiTarget className="text-gold-metallic text-lg" />
                    <span className="text-sm font-medium">Solutions sur mesure</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <FiTrendingUp className="text-gold-metallic text-lg" />
                    <span className="text-sm font-medium">Optimisation fiscale</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <FiAward className="text-gold-metallic text-lg" />
                    <span className="text-sm font-medium">Expertise réglementaire</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <FiUsers className="text-gold-metallic text-lg" />
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="group relative overflow-hidden rounded-2xl border border-[var(--gold-metallic)]/25 bg-[var(--pure-white)]/80 backdrop-blur-sm p-6">
                ...
                <p className="text-secondary text-sm">Structuration d'une solution hybride dette/fonds propres avec optimisation fiscale majeure.</p>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-[var(--gold-metallic)]/25 bg-[var(--pure-white)]/80 backdrop-blur-sm p-6">
                ...
                <p className="text-secondary text-sm">Conception d'une structure d'investissement innovante adaptée aux spécificités du secteur tech.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div ref={capsGridRef} className="reveal-stagger grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              <div className="group relative overflow-hidden rounded-2xl border border-[var(--gold-metallic)]/25 bg-[var(--pure-white)]/80 backdrop-blur-sm p-6 transition-all card-hover">
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-secondary text-sm mb-3">Conception sur mesure des termes financiers, modélisation avancée, optimisation des instruments et évaluation des risques.</p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Modélisation</span>
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Risques</span>
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Optimisation</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-[var(--gold-metallic)]/25 bg-[var(--pure-white)]/80 backdrop-blur-sm p-6 transition-all card-hover">
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <div className="font-display text-lg mb-1">Conseil stratégique</div>
                    <p className="text-secondary text-sm mb-3">Préparation à l'émission, stratégie de communication, gouvernance d'entreprise et conformité réglementaire.</p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Gouvernance</span>
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Communication</span>
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Réglementaire</span>
                    </div>
                  </div>
                </div>
                <div className="mt-5 h-px w-full bg-gradient-to-r from-transparent via-[var(--gold-metallic-10)] to-transparent" />
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-[var(--gold-metallic)]/25 bg-[var(--pure-white)]/80 backdrop-blur-sm p-6 transition-all card-hover">
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <div className="font-display text-lg mb-1">Placement et exécution</div>
                    <p className="text-secondary text-sm mb-3">Accès exclusif aux investisseurs, gestion du bookbuilding, allocation optimale et exécution parfaite.</p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Bookbuilding</span>
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Pricing</span>
                      <span className="px-2 py-1 bg-[var(--gold-light)]/20 text-xs rounded-md">Allocation</span>
                    </div>
                  </div>
                </div>
        ...
        <section id="processus" ref={processSectionRef} className="reveal py-14 sm:py-18 bg-[var(--white-smoke)]">
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="luxury-subheading mt-5">Chaque étape est conçue pour optimiser les résultats et minimiser les risques.</p>
            </div>
