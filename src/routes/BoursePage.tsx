  ...
  return (
    <div className="min-h-screen bg-[var(--pure-white)] text-[var(--night)]">
      ...
      <main className="pt-24 sm:pt-28 lg:pt-32">
        ...
        <section ref={heroRef} className="reveal py-16 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-6xl px-6 text-center">
            ...
            <p className="luxury-subheading mt-5 leading-relaxed">Aperçu des principaux indices et mouvements récents sur la BRVM.</p>
          </div>
        </section>
        ...
        <section ref={overviewSectionRef} className="reveal py-12 sm:py-16 lg:py-20 bg-[var(--white-smoke)]/60 border-y border-[var(--night)]/5">
          <div className="mx-auto max-w-6xl px-6">
            <div ref={overviewGridRef} className="reveal-stagger grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 lg:gap-10 numeric-tabular">
              <div className="stat-card rounded-2xl p-6 md:p-7 lg:p-8">
                <div className="text-xs md:text-sm text-secondary">BRVM 10</div>
                <div className="font-display text-2xl md:text-3xl mt-1">178,52</div>
                <div className="mt-2 inline-flex items-center gap-1 text-[var(--success-700)] text-sm md:text-base">
                  <FiArrowUpRight /> +0,84%
                </div>
              </div>
              <div className="stat-card rounded-2xl p-6 md:p-7 lg:p-8">
                <div className="text-xs md:text-sm text-secondary">BRVM Composite</div>
                <div className="font-display text-2xl md:text-3xl mt-1">230,14</div>
                <div className="mt-2 inline-flex items-center gap-1 text-[var(--danger-700)] text-sm md:text-base">
                  <FiArrowDownRight /> -0,21%
                </div>
              </div>
              <div className="stat-card rounded-2xl p-6 md:p-7 lg:p-8">
                <div className="text-xs md:text-sm text-secondary">Volume quotidien</div>
                <div className="font-display text-2xl md:text-3xl mt-1">1,8 Mds XOF</div>
                <div className="mt-2 inline-flex items-center gap-1 text-[var(--night-80)]/80 text-sm md:text-base">
        ...
        <section ref={movesSectionRef} className="reveal py-14 sm:py-18 lg:py-20">
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="luxury-subheading mt-5 leading-relaxed">Gagnants, perdants et volumes remarquables de la séance.</p>
            </div>
            <div ref={movesGridRef} className="reveal-stagger grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 mt-12">
              {[
                ...
                <div key={b.label} className="group relative overflow-hidden rounded-2xl border border-[var(--gold-metallic)]/25 bg-[var(--pure-white)]/80 backdrop-blur-sm p-6 md:p-7 lg:p-8 transition-all card-hover">
                  <div className="pointer-events-none absolute -top-10 -right-10 w-40 h-40 rounded-full bg-[var(--gold-metallic-10)] blur-2xl" />
                  <div className="font-display text-lg md:text-xl mb-1">{b.label}</div>
                  <ul className="text-sm md:text-base mt-2 space-y-1 leading-relaxed">
                    {b.list.map((item) => (
